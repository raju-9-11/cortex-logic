...
/**
 * JS/Web implementation of [NexusSettings] backed by [kotlinx.browser.localStorage].
 *
 * Provides the same key-value persistence contract as [AndroidNexusSettings]
 ...
 *   own keys to avoid collisions with non-Nexus localStorage entries.
 *
 * Limitations:
 ...
 */
class JsNexusSettings : NexusSettings {
