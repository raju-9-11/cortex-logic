...
import com.agnes.ara.core.domain.services.ParsedCommandEnvelope
import kotlinx.serialization.encodeToString
import kotlinx.serialization.json.*
import kotlin.js.JsExport

/**
 * JS facade for AraRoutingService.
 *
 ...
 */
@JsExport
class AraRoutingServiceJs {

    private val json = Json { ignoreUnknownKeys = true }
    private val service = AraRoutingService()
