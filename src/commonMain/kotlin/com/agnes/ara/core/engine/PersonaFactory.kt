...
import com.agnes.ara.core.domain.services.atlas.AtlasBlueprintService
import com.agnes.ara.core.domain.services.atlas.AtlasPlanningEngine
import com.agnes.ara.core.domain.services.atlas.AtlasProactiveService
...
import com.agnes.ara.core.domain.services.titan.TitanSessionPromptOptions
import com.agnes.ara.core.engine.personas.NsvPromptFragments
import com.agnes.ara.core.engine.personas.PersonaPrompt
import com.agnes.ara.core.engine.personas.PersonaPromptCatalog
import com.agnes.ara.core.engine.personas.ledger.LedgerPromptBuilder
import com.agnes.ara.core.engine.personas.ledger.LedgerContextMode
import kotlinx.datetime.toLocalDateTime
import com.agnes.ara.core.engine.personas.ledger.LedgerPersonaPrompts
import com.agnes.ara.core.engine.personas.ledger.BudgetSnapshot
import com.agnes.ara.core.engine.personas.ledger.GoalSnapshot
import com.agnes.ara.core.engine.personas.ledger.BudgetLineItem
import com.agnes.ara.core.engine.personas.ledger.SimpleTransaction
import com.agnes.ara.core.engine.personas.ledger.FinancialPlan
import com.agnes.ara.core.engine.personas.ledger.PlanAllocation
...
class DefaultPersonaFactory : PersonaFactory {
    ...
    override fun assemble(
        ...
        val agentGender = when (agentGenderToken) {
            "female" -> com.agnes.ara.core.domain.models.GenderPersonality.FEMALE
            "male" -> com.agnes.ara.core.domain.models.GenderPersonality.MALE
            "non-binary", "non_binary" -> com.agnes.ara.core.domain.models.GenderPersonality.NON_BINARY
            "gender-fluid", "gender_fluid" -> com.agnes.ara.core.domain.models.GenderPersonality.GENDER_FLUID
            else -> null
        }
    ...
    private fun buildOverlayBlock(personaPrompt: PersonaPrompt?, overlay: com.agnes.ara.core.domain.models.PersonaOverlay?): String {
