...
import com.agnes.ara.core.domain.models.AtlasJournalEntry
import com.agnes.ara.core.domain.models.AtlasProfile
import com.agnes.ara.core.domain.models.ForgeArtifact
import com.agnes.ara.core.domain.models.ForgeExecutionRecord
...
import com.agnes.ara.core.domain.models.SessionSummary
...
import com.agnes.ara.core.domain.models.TherapyIdentity
import com.agnes.ara.core.domain.models.TherapistPreference
import com.agnes.ara.core.domain.models.TrainerProfile
import com.agnes.ara.core.domain.models.Routine
import com.agnes.ara.core.domain.models.WorkoutSession
import com.agnes.ara.core.domain.models.ExerciseLog
import com.agnes.ara.core.domain.models.ExerciseSet
import com.agnes.ara.core.domain.models.PersonalRecord
import com.agnes.ara.core.domain.models.SleepEntry
import com.agnes.ara.core.domain.models.CycleEntry
import com.agnes.ara.core.domain.models.CyclePhase
import com.agnes.ara.core.domain.models.BodyWeightEntry
import com.agnes.ara.core.domain.models.CardioSession
import com.agnes.ara.core.domain.models.TitanCustomField
import com.agnes.ara.core.domain.models.DebtItem
import com.agnes.ara.core.domain.models.DebtType
import com.agnes.ara.core.domain.models.LedgerExpense
import com.agnes.ara.core.domain.models.LedgerTransaction
import com.agnes.ara.core.domain.models.LedgerBudgetCategory
import com.agnes.ara.core.domain.models.LedgerFinancialGoal
...
import com.agnes.ara.core.domain.models.AtlasTaskNode
import com.agnes.ara.core.domain.models.AtlasProject
import com.agnes.ara.core.domain.models.EnergyWavePoint
import com.agnes.ara.core.domain.models.RecoveryWindow
import com.agnes.ara.core.domain.models.ScheduledTask
import com.agnes.ara.core.domain.models.DailyIntention
import com.agnes.ara.core.domain.models.DailyCheckInEntry
import com.agnes.ara.core.domain.models.HabitLogEntry
import com.agnes.ara.core.domain.models.TemporalReview
import com.agnes.ara.core.domain.models.HabitWeekSummary
import com.agnes.ara.core.domain.models.GoalWeekProgress
import com.agnes.ara.core.domain.models.EncryptedEnvelope
import com.agnes.ara.core.domain.models.toMap
import com.agnes.ara.core.domain.services.DefaultFieldValidators
import com.agnes.ara.core.domain.services.FieldValidationContext
import com.agnes.ara.core.domain.services.FieldValidationRouter
import com.agnes.ara.core.domain.services.FieldValueValidationRequest
import com.agnes.ara.core.domain.services.AraLogger
import com.agnes.ara.core.domain.services.SchemaRegistry
...
import com.agnes.ara.core.domain.services.AraOrderBy
import com.agnes.ara.core.domain.services.AraQuery
import com.agnes.ara.core.domain.services.AraQueryFilter
...
class ActionHub(
    ...
    private val settings: com.agnes.ara.core.domain.services.AraSettings? = null
) {
    ...
    suspend fun execute(action: ActionCall) {
        ...
        if (nsvReadOnlyModules.contains(moduleId) && nsvWriteActionTypes.contains(action.type)) {
            AraLogger.warn("ActionHub", "Module \"$moduleId\" is NSV read-only; blocked ${action.type}")
            return
        }
        ...
        if (handler != null) {
            ...
            AraLogger.action(moduleId, action.type, action.payload.toMap())
            return
        }
        ...
        AraLogger.warn("ActionHub", "No handler for \"${action.type}\" in module \"$moduleId\"")
    }
    ...
    private suspend fun handleProposeReminder(call: ActionCall, moduleId: String) {
        ...
        runCatching {
            ...
            AraLogger.warn("ActionHub", "propose_reminder: failed to persist reminder for $moduleId: ${e.message}")
        }
            ...
            runCatching {
                layer.query(
                    AraQuery(
                        ...
                        where = listOf(
                            AraQueryFilter("moduleId", "==", moduleId),
                            AraQueryFilter("status", "in", listOf("pending", "completed"))
                        ),
                        orderBy = listOf(AraOrderBy("scheduledAt", "asc")),
                        limit = 50
                    )
                ) { raw -> raw }
            }.getOrElse { e ->
                AraLogger.warn("ActionHub", "query_reminders: failed for $moduleId: ${e.message}")
                emptyList()
            }
        } else {
            emptyList()
    ...
    private suspend fun handleCompleteReminder(call: ActionCall, moduleId: String) {
        ...
        runCatching {
            ...
            AraLogger.warn("ActionHub", "complete_reminder: failed for $moduleId/$reminderId: ${e.message}")
        }
    ...
    private suspend fun handleSnoozeReminder(call: ActionCall, moduleId: String) {
        ...
        runCatching {
            ...
            AraLogger.warn("ActionHub", "snooze_reminder: failed for $moduleId/$reminderId: ${e.message}")
        }
    ...
    private suspend fun handleSuggestField(call: ActionCall) {
        ...
        val result = SchemaRegistry.extendSchema(moduleId, listOf(field))
        if (!result.valid) {
            AraLogger.warn("ActionHub", "suggest_field rejected for module=$moduleId fieldId=$fieldId")
            return
        }
        ...
        val newRoutines = routinesArray.mapNotNull { el ->
            ...
            Routine(
                ...
                exercises = (obj["exercises"] as? JsonArray)?.mapNotNull { exEl ->
                    ...
                    com.agnes.ara.core.domain.models.Exercise(
    ...
    private suspend fun handleTitanLogBodyFat(call: ActionCall) {
        ...
        val date = call.payload["date"]?.jsonPrimitive?.content?.takeIf { it.length >= 10 } ?: nowIso().take(10)
        val entry = com.agnes.ara.core.domain.models.BodyFatEntry(
    ...
    private suspend fun handleTitanLogInjury(call: ActionCall) {
        ...
        val entry = com.agnes.ara.core.domain.models.TitanInjury(
    ...
    private suspend fun handleTitanLogSupplement(call: ActionCall) {
        ...
        val entry = com.agnes.ara.core.domain.models.SupplementEntry(
    ...
    private suspend fun handleTitanLogMeal(call: ActionCall) {
        ...
        val entry = com.agnes.ara.core.domain.models.MealEntry(
    ...
    private suspend fun handleTitanLogMacros(call: ActionCall) {
        ...
        val entry = com.agnes.ara.core.domain.models.DailyMacroLog(
    ...
    private suspend fun handleTitanScheduleWorkout(call: ActionCall) {
        ...
        val plan = com.agnes.ara.core.domain.models.PlannedWorkout(
    ...
    private suspend fun removeExtensionFieldValue(
        ...
        if (encryptionKey != null && vaultBoundary != null && encryptedObj != null) {
            ...
            if (ciphertext != null && iv != null) {
                val decrypted = runCatching {
                    vault.decrypt(
                        com.agnes.ara.core.domain.models.EncryptedEnvelope(ciphertext = ciphertext, iv = iv),
                        encryptionKey
                    )
                }.getOrNull()
                if (decrypted != null) {
