...
import com.agnes.nexus.core.domain.services.NexusHandoffService
...
class OrchestratorActions(
    ...
    private val handoffService: NexusHandoffService,
    private val routingService: NexusRoutingService,
    ...
    private fun registerCreateModuleHandoff() {
        actionHub.register("nexus", "create_module_handoff") { call ->
            ...
            handoffService.store(
                NexusHandoffService.NexusHandoff(
                    moduleId = moduleId,
                    type = "delegate",
                    content = content,
                    reason = reason,
...
fun registerOrchestratorActions(
    actionHub: ActionHub,
    handoffService: NexusHandoffService,
    routingService: NexusRoutingService,
    nsvService: NeuralProjectionService,
    eventBus: SpineEventBus,
    dataLayer: NexusDataLayer? = null
) {
    OrchestratorActions(
        actionHub = actionHub,
