...
import com.agnes.nexus.core.domain.services.atlas.AtlasPromptBuilder.CapacityBlueprint
import com.agnes.nexus.core.domain.services.atlas.AtlasPromptBuilder.CapacitySnapshot
import com.agnes.nexus.core.domain.services.atlas.AtlasPromptBuilder.CapacityVectors
import com.agnes.nexus.core.domain.services.atlas.AtlasPromptBuilder.DailyCapacityEstimate
import com.agnes.nexus.core.domain.services.atlas.AtlasPromptBuilder.ProjectionSurface
import com.agnes.nexus.core.domain.services.atlas.AtlasPromptBuilder.ReviewAction
import com.agnes.nexus.core.domain.services.atlas.AtlasPromptBuilder.ReviewBlueprint
...
object AtlasBlueprintService {
    ...
    private fun estimateScheduledDemand(tasks: List<com.agnes.nexus.core.domain.models.ScheduledTask>, now: Instant, tz: TimeZone): Double {
