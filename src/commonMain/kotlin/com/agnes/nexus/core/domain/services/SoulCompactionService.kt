...
import com.agnes.nexus.core.engine.MemoryManager
...
class SoulCompactionService(
    ...
    suspend fun compactIfNeeded(
        ...
        val tokens = mutableListOf<com.agnes.nexus.core.domain.model.SemanticToken>()
        try {
            ...
            if (!response.isNullOrBlank()) {
                ...
                facts.forEach { fact ->
                    val token = com.agnes.nexus.core.domain.model.SemanticToken(
...
data class CompactionResult(
    ...
    val newTokens: List<com.agnes.nexus.core.domain.model.SemanticToken>
)
