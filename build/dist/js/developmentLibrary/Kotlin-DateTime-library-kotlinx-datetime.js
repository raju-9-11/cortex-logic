(function (factory) {
  ...
  var objectCreate = kotlin_kotlin.$_$.ee;
  ...
  var toDuration = kotlin_kotlin.$_$.si;
  ...
  var RuntimeException_init_$Init$_0 = kotlin_kotlin.$_$.s2;
  var RuntimeException_init_$Init$_1 = kotlin_kotlin.$_$.q2;
  var RuntimeException_init_$Init$_2 = kotlin_kotlin.$_$.u2;
  ...
  var KMutableProperty1 = kotlin_kotlin.$_$.ff;
  var getPropertyCallableRef = kotlin_kotlin.$_$.yc;
  var KMutableProperty0 = kotlin_kotlin.$_$.ef;
  ...
  var Char__rangeTo_impl_tkncvp = kotlin_kotlin.$_$.s3;
  ...
  var getOrNull = kotlin_kotlin.$_$.r8;
  ...
  var toMutableList = kotlin_kotlin.$_$.va;
  var addAll = kotlin_kotlin.$_$.e7;
  var firstOrNull = kotlin_kotlin.$_$.n8;
  ...
  var compareTo = kotlin_kotlin.$_$.sc;
  var removePrefix = kotlin_kotlin.$_$.yg;
  ...
  var KProperty1 = kotlin_kotlin.$_$.hf;
  var numberToLong = kotlin_kotlin.$_$.de;
  var numberToInt = kotlin_kotlin.$_$.ce;
  ...
  protoOf(System).now_2cba_k$ = function () {
    return Companion_getInstance_19().now_2cba_k$();
  };
  var System_instance;
  ...
  function todayIn(_this__u8e3s4, timeZone) {
    return toLocalDateTime_0(_this__u8e3s4.now_2cba_k$(), timeZone).get_date_wokkxj_k$();
  }
  ...
  protoOf(Companion_0).parse_pc1q8p_k$ = function (text) {
    var period = Companion_getInstance_2().parse_pc1q8p_k$(text);
    var tmp;
    if (period instanceof DatePeriod) {
      tmp = period;
    } else {
      throw DateTimeFormatException_init_$Create$_0('Period ' + period.toString() + ' (parsed from string ' + text + ') is not date-based');
    }
    return tmp;
  };
  ...
  protoOf(DatePeriod).get_totalMonths_xmlea9_k$ = function () {
  ...
  protoOf(DatePeriod).get_totalNanoseconds_kpeleb_k$ = function () {
    return new Long(0, 0);
  };
  ...
  function parse$toIntThrowing(_this__u8e3s4, iStart, component) {
    if (_this__u8e3s4.compareTo_9jj042_k$(new Long(-2147483648, -1)) < 0 || _this__u8e3s4.compareTo_9jj042_k$(new Long(2147483647, 0)) > 0) {
  ...
  function allNonpositive($this) {
    return $this.get_totalMonths_xmlea9_k$() <= 0 && $this.get_days_wokl28_k$() <= 0 && $this.get_totalNanoseconds_kpeleb_k$().compareTo_9jj042_k$(new Long(0, 0)) <= 0 && (!(($this.get_totalMonths_xmlea9_k$() | $this.get_days_wokl28_k$()) === 0) || !$this.get_totalNanoseconds_kpeleb_k$().equals(new Long(0, 0)));
  }
  function Companion_1() {
    Companion_instance_1 = this;
  }
  protoOf(Companion_1).parse_pc1q8p_k$ = function (text) {
    var START = 0;
    var AFTER_P = 1;
    var AFTER_YEAR = 2;
    var AFTER_MONTH = 3;
    ...
    $l$loop_0: while (true) {
      if (i >= text.length) {
        ...
        var n = tmp0.plus_r93sks_k$(toLong(other));
        var tmp;
      ...
      number = tmp4.times_nfzjiw_k$(toLong(other_0));
      if (i === text.length) {
  ...
  protoOf(DateTimePeriod).get_years_j1r3xp_k$ = function () {
    return this.get_totalMonths_xmlea9_k$() / 12 | 0;
  };
  protoOf(DateTimePeriod).get_months_gqmrjw_k$ = function () {
    return this.get_totalMonths_xmlea9_k$() % 12 | 0;
  };
  protoOf(DateTimePeriod).get_hours_islejq_k$ = function () {
    return this.get_totalNanoseconds_kpeleb_k$().div_jun7gj_k$(new Long(817405952, 838)).toInt_1tsl84_k$();
  };
  protoOf(DateTimePeriod).get_minutes_ivkhkm_k$ = function () {
    return this.get_totalNanoseconds_kpeleb_k$().rem_bsnl9o_k$(new Long(817405952, 838)).div_jun7gj_k$(new Long(-129542144, 13)).toInt_1tsl84_k$();
  };
  protoOf(DateTimePeriod).get_seconds_xuhyfq_k$ = function () {
    var tmp0 = this.get_totalNanoseconds_kpeleb_k$().rem_bsnl9o_k$(new Long(-129542144, 13));
    // Inline function 'kotlin.Long.div' call
    var other = 1000000000;
    return tmp0.div_jun7gj_k$(toLong(other)).toInt_1tsl84_k$();
  };
  protoOf(DateTimePeriod).get_nanoseconds_3zfxge_k$ = function () {
    var tmp0 = this.get_totalNanoseconds_kpeleb_k$();
    // Inline function 'kotlin.Long.rem' call
    var other = 1000000000;
    return tmp0.rem_bsnl9o_k$(toLong(other)).toInt_1tsl84_k$();
  };
  protoOf(DateTimePeriod).toString = function () {
    ...
    var sign = tmp;
    this_0.append_am5a4z_k$(_Char___init__impl__6a9atx(80));
    if (!(this.get_years_j1r3xp_k$() === 0)) {
      this_0.append_uppzia_k$(imul(this.get_years_j1r3xp_k$(), sign)).append_am5a4z_k$(_Char___init__impl__6a9atx(89));
    }
    if (!(this.get_months_gqmrjw_k$() === 0)) {
      this_0.append_uppzia_k$(imul(this.get_months_gqmrjw_k$(), sign)).append_am5a4z_k$(_Char___init__impl__6a9atx(77));
    }
    if (!(this.get_days_wokl28_k$() === 0)) {
      this_0.append_uppzia_k$(imul(this.get_days_wokl28_k$(), sign)).append_am5a4z_k$(_Char___init__impl__6a9atx(68));
    }
    var t = 'T';
    if (!(this.get_hours_islejq_k$() === 0)) {
      // Inline function 'kotlin.also' call
      this_0.append_22ad7x_k$(t).append_uppzia_k$(imul(this.get_hours_islejq_k$(), sign)).append_am5a4z_k$(_Char___init__impl__6a9atx(72));
      t = '';
    }
    if (!(this.get_minutes_ivkhkm_k$() === 0)) {
      // Inline function 'kotlin.also' call
      this_0.append_22ad7x_k$(t).append_uppzia_k$(imul(this.get_minutes_ivkhkm_k$(), sign)).append_am5a4z_k$(_Char___init__impl__6a9atx(77));
      t = '';
    }
    if (!((this.get_seconds_xuhyfq_k$() | this.get_nanoseconds_3zfxge_k$()) === 0)) {
      this_0.append_22ad7x_k$(t);
      this_0.append_t8pm91_k$(!(this.get_seconds_xuhyfq_k$() === 0) ? imul(this.get_seconds_xuhyfq_k$(), sign) : imul(this.get_nanoseconds_3zfxge_k$(), sign) < 0 ? '-0' : '0');
      if (!(this.get_nanoseconds_3zfxge_k$() === 0)) {
        var tmp_0 = this_0.append_am5a4z_k$(_Char___init__impl__6a9atx(46));
        // Inline function 'kotlin.math.absoluteValue' call
        var this_1 = this.get_nanoseconds_3zfxge_k$();
        var tmp$ret$4 = abs(this_1);
        tmp_0.append_22ad7x_k$(padStart(tmp$ret$4.toString(), 9, _Char___init__impl__6a9atx(48)));
      }
      this_0.append_am5a4z_k$(_Char___init__impl__6a9atx(83));
    }
    if (this_0.get_length_g42xv3_k$() === 1) {
      this_0.append_22ad7x_k$('0D');
    }
  ...
  protoOf(DateTimePeriod).equals = function (other) {
    ...
    if (!(other instanceof DateTimePeriod))
      return false;
    if (!(this.get_totalMonths_xmlea9_k$() === other.get_totalMonths_xmlea9_k$()))
      return false;
    if (!(this.get_days_wokl28_k$() === other.get_days_wokl28_k$()))
      return false;
    if (!this.get_totalNanoseconds_kpeleb_k$().equals(other.get_totalNanoseconds_kpeleb_k$()))
      return false;
    return true;
  };
  protoOf(DateTimePeriod).hashCode = function () {
    var result = this.get_totalMonths_xmlea9_k$();
    result = imul(31, result) + this.get_days_wokl28_k$() | 0;
    result = imul(31, result) + this.get_totalNanoseconds_kpeleb_k$().hashCode() | 0;
    return result;
  };
  function totalMonths(years, months) {
    // Inline function 'kotlin.Long.times' call
    var totalMonths = toLong(years).times_nfzjiw_k$(toLong(12)).plus_r93sks_k$(toLong(months));
    var tmp;
    // Inline function 'kotlin.ranges.contains' call
    var this_0 = numberRangeToNumber(-2147483648, 2147483647);
  ...
  function totalNanoseconds(hours, minutes, seconds, nanoseconds) {
    // Inline function 'kotlin.Long.times' call
    // Inline function 'kotlin.Long.plus' call
    var totalMinutes = toLong(hours).times_nfzjiw_k$(toLong(60)).plus_r93sks_k$(toLong(minutes));
    // Inline function 'kotlin.Long.times' call
    var totalMinutesAsSeconds = totalMinutes.times_nfzjiw_k$(toLong(60));
    // Inline function 'kotlin.Long.div' call
    var other = 1000000000;
    var tmp$ret$3 = nanoseconds.div_jun7gj_k$(toLong(other));
    var minutesAndNanosecondsAsSeconds = totalMinutesAsSeconds.plus_r93sks_k$(tmp$ret$3);
    // Inline function 'kotlin.Long.plus' call
    var totalSeconds = minutesAndNanosecondsAsSeconds.plus_r93sks_k$(toLong(seconds));
    var tmp;
    try {
      var tmp_0 = new Long(1000000000, 0);
      // Inline function 'kotlin.Long.rem' call
      var other_0 = 1000000000;
      var tmp$ret$5 = nanoseconds.rem_bsnl9o_k$(toLong(other_0));
  ...
  protoOf(DateTimePeriodImpl).get_totalMonths_xmlea9_k$ = function () {
    return this.totalMonths_1;
  };
  protoOf(DateTimePeriodImpl).get_days_wokl28_k$ = function () {
    return this.days_1;
  };
  protoOf(DateTimePeriodImpl).get_totalNanoseconds_kpeleb_k$ = function () {
  ...
  function DateTimeComponents$Formats$RFC_1123$lambda($this$Format) {
    ...
    $this$Format.monthName_asbkgr_k$(Companion_getInstance_10().get_ENGLISH_ABBREVIATED_cfvc81_k$());
    char($this$Format, _Char___init__impl__6a9atx(32));
  ...
  function DateTimeComponents$Formats$RFC_1123$lambda$lambda_0($this$alternativeParsing) {
    $this$alternativeParsing.dayOfWeek_tn8lxa_k$(Companion_getInstance_11().get_ENGLISH_ABBREVIATED_cfvc81_k$());
  ...
  protoOf(Companion_7).Format_xzgceo_k$ = function (block) {
  ...
  protoOf(DateTimeComponents).setDateTimeOffset_t1ks5q_k$ = function (instant, utcOffset) {
    var smallerInstant = Companion_getInstance_19().fromEpochSeconds_idu11y_k$(instant.get_epochSeconds_w76ght_k$().rem_bsnl9o_k$(new Long(2036907392, 73)), instant.get_nanosecondsOfSecond_n2ey8j_k$());
  ...
  protoOf(DateTimeComponents).toInstantUsingOffset_6s0427_k$ = function () {
    ...
    if (totalSeconds.compareTo_9jj042_k$(Companion_getInstance_19().get_MIN_za2zu4_k$().get_epochSeconds_w76ght_k$()) < 0 || totalSeconds.compareTo_9jj042_k$(Companion_getInstance_19().get_MAX_ieaqrm_k$().get_epochSeconds_w76ght_k$()) > 0)
  ...
  protoOf(Builder).timeZoneId_ev7lfo_k$ = function () {
    return this.actualBuilder_1.add_b6pdwl_k$(new BasicFormatStructure(new TimeZoneIdDirective(Companion_getInstance_23().get_availableZoneIds_kceyfo_k$())));
  };
  ...
  protoOf(Companion_8).formatAsKotlinBuilderDsl_pv4218_k$ = function (format) {
    var tmp;
  ...
  function char(_this__u8e3s4, value) {
    return _this__u8e3s4.chars_pe6iqb_k$(toString(value));
  }
  ...
  protoOf(Companion_9).get_ENGLISH_FULL_w9oxw9_k$ = function () {
    return this.ENGLISH_FULL_1;
  };
  protoOf(Companion_9).get_ENGLISH_ABBREVIATED_cfvc81_k$ = function () {
  ...
  protoOf(Companion_10).get_ENGLISH_FULL_w9oxw9_k$ = function () {
    return this.ENGLISH_FULL_1;
  };
  protoOf(Companion_10).get_ENGLISH_ABBREVIATED_cfvc81_k$ = function () {
    return this.ENGLISH_ABBREVIATED_1;
  };
  ...
  protoOf(Companion_11).build_o3smjo_k$ = function (block) {
  ...
  function toKotlinCode_0(_this__u8e3s4) {
    ...
    var tmp;
    if (equals(tmp0_subject, Companion_getInstance_10().ENGLISH_FULL_1.names_1)) {
      Companion_getInstance_11();
      tmp = 'MonthNames.' + 'ENGLISH_FULL';
    } else if (equals(tmp0_subject, Companion_getInstance_10().ENGLISH_ABBREVIATED_1.names_1)) {
      Companion_getInstance_11();
  ...
  function toKotlinCode_1(_this__u8e3s4) {
    ...
    var tmp0_subject = _this__u8e3s4.names_1;
    var tmp;
    if (equals(tmp0_subject, Companion_getInstance_11().ENGLISH_FULL_1.names_1)) {
      Companion_getInstance_11();
      tmp = 'DayOfWeekNames.' + 'ENGLISH_FULL';
    } else if (equals(tmp0_subject, Companion_getInstance_11().ENGLISH_ABBREVIATED_1.names_1)) {
      Companion_getInstance_11();
  ...
  protoOf(Companion_12).build_jyqq35_k$ = function (block) {
  ...
  protoOf(Companion_13).build_agwrib_k$ = function (block) {
  ...
  protoOf(Companion_14).get_NO_EXTRA_ZEROS_9wrjkp_k$ = function () {
    return this.NO_EXTRA_ZEROS_1;
  };
  protoOf(Companion_14).get_GROUP_BY_THREE_z0tc3l_k$ = function () {
  ...
  function FractionalSecondDirective(minDigits, maxDigits, zerosToAdd) {
    ...
    zerosToAdd = zerosToAdd === VOID ? Companion_getInstance_15().NO_EXTRA_ZEROS_1 : zerosToAdd;
  ...
  protoOf(Companion_15).build_dzztnl_k$ = function (block) {
  ...
  function NamedUnsignedIntFieldFormatDirective(field, values, name) {
    ...
    if (!(this.values_1.get_size_woubt6_k$() === ((this.field_1.get_maxValue_p78wqy_k$() - this.field_1.get_minValue_ggd348_k$() | 0) + 1 | 0))) {
      var message = 'The number of values (' + this.values_1.get_size_woubt6_k$() + ') in ' + toString_0(this.values_1) + ' does not match the range of the field (' + ((this.field_1.get_maxValue_p78wqy_k$() - this.field_1.get_minValue_ggd348_k$() | 0) + 1 | 0) + ')';
      throw IllegalArgumentException_init_$Create$(toString_0(message));
    }
  }
  ...
  protoOf(NamedUnsignedIntFieldFormatDirective).parser_ggn3z5_k$ = function () {
    return new ParserStructure(listOf_0(new StringSetParserOperation(this.values_1, new AssignableString(this), 'one of ' + toString_0(this.values_1) + ' for ' + this.name_1)), emptyList());
  };
  ...
  protoOf(NamedEnumIntFieldFormatDirective).parser_ggn3z5_k$ = function () {
    return new ParserStructure(listOf_0(new StringSetParserOperation(this.mapping_1.get_values_ksazhn_k$(), new AssignableString_0(this), 'one of ' + toString_0(this.mapping_1.get_values_ksazhn_k$()) + ' for ' + this.name_1)), emptyList());
  };
  ...
  protoOf(BasicFormatStructure).toString = function () {
    return 'BasicFormatStructure(' + toString_0(this.directive_1) + ')';
  };
  ...
  protoOf(SignedFormatStructure).toString = function () {
    return 'SignedFormatStructure(' + toString_0(this.format_1) + ')';
  };
  ...
  protoOf(SignedFormatStructure).parser_ggn3z5_k$ = function () {
    return concat(listOf([new ParserStructure(listOf_0(new SignParser(SignedFormatStructure$parser$lambda(this), this.withPlusSign_1, 'sign for ' + toString_0(this.fieldSigns_1))), emptyList()), this.format_1.parser_ggn3z5_k$()]));
  };
  ...
  protoOf(Companion_16).fromField_3ctjbq_k$ = function (field) {
  ...
  function OptionalFormatStructure(onZero, format) {
    ...
    while (_iterator__ex2g4s_0.hasNext_bitz1p_k$()) {
      ...
      var tmp$ret$3 = Companion_getInstance_17().fromField_3ctjbq_k$(item_0);
  ...
  protoOf(OptionalFormatStructure).toString = function () {
    return 'Optional(' + this.onZero_1 + ', ' + toString_0(this.format_1) + ')';
  };
  ...
  protoOf(AlternativesParsingFormatStructure).toString = function () {
    return 'AlternativesParsing(' + toString_0(this.formats_1) + ')';
  };
  ...
  protoOf(ConstantNumberConsumer).consume_o77i9d_k$ = function (storage, input, start, end) {
    var tmp;
    // Inline function 'kotlin.text.substring' call
    if (toString_0(charSequenceSubSequence(input, start, end)) === this.expected_1) {
      tmp = null;
    } else {
  ...
  protoOf(Conflicting).errorMessage_jwdivz_k$ = function () {
    return "attempted to overwrite the existing value '" + toString_0(this.conflicting_1) + "'";
  };
  ...
  protoOf(Companion_17).Ok_6vkbj8_k$ = function (indexOfNextUnparsed) {
    return _ParseResult___init__impl__gvz3cn(indexOfNextUnparsed);
  };
  protoOf(Companion_17).Error_ca056s_k$ = function (position, message) {
  ...
  function ParseResult__match_impl_30t8rc($this, onSuccess, onFailure) {
    ...
    if (typeof tmp0_subject === 'number') {
      ...
      if (tmp0_subject instanceof ParseError) {
        ...
        var message = 'Unexpected parse result: ' + toString_0(_ParseResult___get_value__impl__86mnxf($this));
  ...
  function ParseResult__toString_impl_foa9an($this) {
    return 'ParseResult(value=' + toString_0($this) + ')';
  }
    ...
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      ...
      while (inductionVariable < last) {
        ...
        if (searchResult < 0) {
          ...
          node.children_1.add_dl6gt3_k$((-searchResult | 0) - 1 | 0, to(toString(char), this_0));
          tmp = this_0;
        } else {
  ...
  function _get_whatThisExpects__4pg11j_0($this) {
    ...
    if ($this.isFlexible_1) {
      tmp = 'a number with at least ' + $this.minLength_1 + ' digits: ' + toString_0(consumerLengths);
    } else {
      tmp = 'a number with exactly ' + $this.minLength_1 + ' digits: ' + toString_0(consumerLengths);
    }
    return tmp;
  }
  ...
  protoOf(NumberSpanParserOperation).consume_ew3o91_k$ = function (storage, input, startIndex) {
    ...
    if (inductionVariable <= last)
      do {
       ...
       while (inductionVariable <= last);
    return Companion_getInstance_18().Ok_6vkbj8_k$(index);
  };
  ...
  protoOf(PlainStringParserOperation).consume_ew3o91_k$ = function (storage, input, startIndex) {
    ...
    if (inductionVariable <= last)
      do {
       ...
       while (inductionVariable <= last);
    return Companion_getInstance_18().Ok_6vkbj8_k$(startIndex + this.string_1.length | 0);
  };
  ...
  function SignParser$consume$lambda(this$0, $char) {
    return function () {
      return 'Expected ' + this$0.whatThisExpects_1 + ' but got ' + toString($char);
    };
  }
  ...
  function setWithoutReassigning_0(_this__u8e3s4, receiver, value, position, nextIndex) {
    ...
    if (conflictingValue === null) {
      tmp = Companion_getInstance_18().Ok_6vkbj8_k$(nextIndex);
    } else {
      var tmp_0 = Companion_getInstance_18();
  ...
  function multiplyAndAdd(d, n, r) {
    ...
    var md = d;
    var mr = r;
    if (d.compareTo_9jj042_k$(new Long(0, 0)) > 0 && r.compareTo_9jj042_k$(new Long(0, 0)) < 0) {
      md = md.dec_24n6_k$();
      mr = mr.plus_r93sks_k$(n);
    } else if (d.compareTo_9jj042_k$(new Long(0, 0)) < 0 && r.compareTo_9jj042_k$(new Long(0, 0)) > 0) {
      md = md.inc_28ke_k$();
      mr = mr.minus_mfbszm_k$(n);
    }
  ...
  function toKotlinCode_2(_this__u8e3s4) {
    return _this__u8e3s4 === _Char___init__impl__6a9atx(39) ? "'\\''" : "'" + toString(_this__u8e3s4) + "'";
  }
  ...
  function DatePeriodIso8601Serializer() {
    ...
    this.descriptor_1 = PrimitiveSerialDescriptor('kotlinx.datetime.DatePeriod', STRING_getInstance());
  }
  protoOf(DatePeriodIso8601Serializer).get_descriptor_wjt6a0_k$ = function () {
    return this.descriptor_1;
  };
  protoOf(DatePeriodIso8601Serializer).deserialize_sy6x50_k$ = function (decoder) {
    var period = Companion_getInstance_2().parse_pc1q8p_k$(decoder.decodeString_x3hxsx_k$());
    var tmp;
    if (period instanceof DatePeriod) {
      tmp = period;
    } else {
  ...
  protoOf(DatePeriodIso8601Serializer).serialize_3e32w3_k$ = function (encoder, value) {
    encoder.encodeString_424b5v_k$(value.toString());
  };
  protoOf(DatePeriodIso8601Serializer).serialize_5ase3y_k$ = function (encoder, value) {
    return this.serialize_3e32w3_k$(encoder, value instanceof DatePeriod ? value : THROW_CCE());
  };
  ...
  function DateTimePeriodIso8601Serializer() {
    ...
    this.descriptor_1 = PrimitiveSerialDescriptor('kotlinx.datetime.DateTimePeriod', STRING_getInstance());
  }
  protoOf(DateTimePeriodIso8601Serializer).get_descriptor_wjt6a0_k$ = function () {
    return this.descriptor_1;
  };
  protoOf(DateTimePeriodIso8601Serializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_2().parse_pc1q8p_k$(decoder.decodeString_x3hxsx_k$());
  };
  protoOf(DateTimePeriodIso8601Serializer).serialize_khwvh_k$ = function (encoder, value) {
    encoder.encodeString_424b5v_k$(value.toString());
  };
  protoOf(DateTimePeriodIso8601Serializer).serialize_5ase3y_k$ = function (encoder, value) {
    return this.serialize_khwvh_k$(encoder, value instanceof DateTimePeriod ? value : THROW_CCE());
  };
  ...
  protoOf(InstantIso8601Serializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_19().parse$default_czyhit_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(LocalDateIso8601Serializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_20().parse$default_krgov1_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(LocalDateTimeIso8601Serializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_21().parse$default_rpbnp3_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(LocalTimeIso8601Serializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_22().parse$default_id2jrv_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(UtcOffsetSerializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_25().parse$default_j5dbmh_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(TimeZoneSerializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_23().of_5gnbr7_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(FixedOffsetTimeZoneSerializer).deserialize_sy6x50_k$ = function (decoder) {
    var zone = Companion_getInstance_23().of_5gnbr7_k$(decoder.decodeString_x3hxsx_k$());
  ...
  protoOf(Companion_18).now_2cba_k$ = function () {
    return new Instant_0(Clock.systemUTC().instant());
  };
  protoOf(Companion_18).fromEpochMilliseconds_e2resj_k$ = function (epochMilliseconds) {
    var tmp;
    try {
      // Inline function 'kotlin.Long.div' call
  ...
  protoOf(Companion_18).parse_tkh7xn_k$ = function (input, format) {
    var tmp;
    try {
  ...
  protoOf(Companion_18).parse$default_czyhit_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_18).fromEpochSeconds_labkcg_k$ = function (epochSeconds, nanosecondAdjustment) {
    var tmp;
    try {
  ...
  protoOf(Companion_18).fromEpochSeconds$default_ryd2jg_k$ = function (epochSeconds, nanosecondAdjustment, $super) {
  ...
  protoOf(Companion_18).fromEpochSeconds_idu11y_k$ = function (epochSeconds, nanosecondAdjustment) {
    var tmp;
    try {
      // Inline function 'kotlinx.datetime.jsTry' call
  ...
  protoOf(Companion_18).get_DISTANT_PAST_yzdqbd_k$ = function () {
    return this.DISTANT_PAST_1;
  };
  protoOf(Companion_18).get_DISTANT_FUTURE_gftwmi_k$ = function () {
  ...
  protoOf(Instant_0).plus_oeswd1_k$ = function (duration) {
    ...
    try {
      ...
      if ($p instanceof Error) {
        ...
        if (!isJodaDateTimeException(e))
          throw e;
        tmp_0 = Duration__isPositive_impl_tvkkt2(duration) ? Companion_getInstance_19().MAX_1 : Companion_getInstance_19().MIN_1;
      } else {
        throw $p;
      }
      tmp = tmp_0;
  ...
  protoOf(Companion_19).parse_18ba6d_k$ = function (input, format) {
    var tmp;
  ...
  protoOf(Companion_19).parse$default_krgov1_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_19).parse_pc1q8p_k$ = function (isoString) {
    return this.parse$default_krgov1_k$(isoString);
  };
  protoOf(Companion_19).get_MIN_za2zu4_k$ = function () {
    return this.MIN_1;
  };
  protoOf(Companion_19).get_MAX_ieaqrm_k$ = function () {
    return this.MAX_1;
  };
  protoOf(Companion_19).fromEpochDays_msuzxa_k$ = function (epochDays) {
    var tmp;
    try {
      // Inline function 'kotlinx.datetime.jsTry' call
  ...
  protoOf(Companion_19).Format_rqffoz_k$ = function (block) {
    return Companion_getInstance_12().build_o3smjo_k$(block);
  };
  ...
  function plus_2(_this__u8e3s4, period) {
    var tmp;
    try {
      // Inline function 'kotlin.with' call
      // Inline function 'kotlin.run' call
      var $this$run = _this__u8e3s4.value_1;
      var tmp_0;
      if (!(period.get_totalMonths_xmlea9_k$() === 0)) {
        // Inline function 'kotlinx.datetime.jsTry' call
        tmp_0 = $this$run.plusMonths(period.get_totalMonths_xmlea9_k$());
      } else {
        tmp_0 = $this$run;
      }
      // Inline function 'kotlin.run' call
      ...
      var tmp_1;
      if (!(period.get_days_wokl28_k$() === 0)) {
        // Inline function 'kotlinx.datetime.jsTry' call
        tmp_1 = $this$run_0.plusDays(period.get_days_wokl28_k$());
      } else {
        tmp_1 = $this$run_0;
      }
      // Inline function 'kotlin.let' call
  ...
  function plusNumber(_this__u8e3s4, value, unit) {
    ...
    try {
      ...
      if ($p instanceof Error) {
        ...
        if (!isJodaDateTimeException(e) && !isJodaArithmeticException(e))
          throw e;
        throw DateTimeArithmeticException_init_$Create$_2('The result of adding ' + toString_0(value) + ' of ' + toString_0(unit) + ' to ' + _this__u8e3s4.toString() + ' is out of LocalDate range.', e);
      } else {
        throw $p;
      }
    }
  ...
  protoOf(Companion_20).parse_bq7xns_k$ = function (input, format) {
    var tmp;
  ...
  protoOf(Companion_20).parse$default_rpbnp3_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_20).parse_pc1q8p_k$ = function (isoString) {
    return this.parse$default_rpbnp3_k$(isoString);
  };
  protoOf(Companion_20).get_MIN_za2zu4_k$ = function () {
    return this.MIN_1;
  };
  protoOf(Companion_20).get_MAX_ieaqrm_k$ = function () {
    return this.MAX_1;
  };
  protoOf(Companion_20).Format_52y7ju_k$ = function (builder) {
    return Companion_getInstance_13().build_jyqq35_k$(builder);
  };
  ...
  protoOf(Companion_21).parse_keg146_k$ = function (input, format) {
    var tmp;
  ...
  protoOf(Companion_21).parse$default_id2jrv_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_21).parse_pc1q8p_k$ = function (isoString) {
    return this.parse$default_id2jrv_k$(isoString);
  };
  protoOf(Companion_21).fromSecondOfDay_ahegcx_k$ = function (secondOfDay) {
    var tmp;
    try {
      // Inline function 'kotlinx.datetime.jsTry' call
      // Inline function 'kotlin.let' call
  ...
  protoOf(Companion_21).fromMillisecondOfDay_pjhtva_k$ = function (millisecondOfDay) {
    var tmp;
    try {
      // Inline function 'kotlinx.datetime.jsTry' call
      // Inline function 'kotlin.let' call
  ...
  protoOf(Companion_21).fromNanosecondOfDay_iksazp_k$ = function (nanosecondOfDay) {
    var tmp;
    try {
      // Inline function 'kotlinx.datetime.jsTry' call
      // Inline function 'kotlin.let' call
  ...
  protoOf(Companion_21).get_MIN_za2zu4_k$ = function () {
    return this.MIN_1;
  };
  protoOf(Companion_21).get_MAX_ieaqrm_k$ = function () {
    return this.MAX_1;
  };
  protoOf(Companion_21).Format_tnsr8s_k$ = function (builder) {
    return Companion_getInstance_14().build_agwrib_k$(builder);
  };
  ...
  protoOf(Companion_22).currentSystemDefault_9rduv_k$ = function () {
    return ofZone(this, ZoneId.systemDefault());
  };
  protoOf(Companion_22).get_UTC_18jizp_k$ = function () {
    return this.UTC_1;
  };
  protoOf(Companion_22).of_5gnbr7_k$ = function (zoneId) {
    var tmp;
    try {
      // Inline function 'kotlinx.datetime.jsTry' call
  ...
  protoOf(Companion_22).get_availableZoneIds_kceyfo_k$ = function () {
  ...
  protoOf(Companion_24).get_ZERO_wodlgx_k$ = function () {
    return this.ZERO_1;
  };
  protoOf(Companion_24).parse_i4pxzt_k$ = function (input, format) {
  ...
  protoOf(Companion_24).parse$default_j5dbmh_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_24).parse_pc1q8p_k$ = function (offsetString) {
    return this.parse$default_j5dbmh_k$(offsetString);
  };
  protoOf(Companion_24).Format_lu8ljq_k$ = function (block) {
    return Companion_getInstance_16().build_dzztnl_k$(block);
  };
  ...
  _.$_$ = _.$_$ || {};
  _.$_$.a = DayOfWeek_SUNDAY_getInstance;
  _.$_$.b = DatePeriod_init_$Create$;
  _.$_$.c = LocalDate_init_$Create$_0;
  _.$_$.d = LocalDateTime_init_$Create$_1;
  _.$_$.e = LocalTime_init_$Create$;
  _.$_$.f = System_getInstance;
  _.$_$.g = Companion_getInstance_7;
  _.$_$.h = Companion_getInstance_19;
  _.$_$.i = Companion_getInstance_20;
  _.$_$.j = Companion_getInstance_23;
  _.$_$.k = plus_2;
  _.$_$.l = plus_1;
  _.$_$.m = toInstant;
  _.$_$.n = toLocalDateTime_0;
  _.$_$.o = todayIn;
  //endregion
  return _;
}));
