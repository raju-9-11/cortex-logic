(function (factory) {
  ...
  var isSurrogate = kotlin_kotlin.$_$.hg;
  var Char__plus_impl_qi7pgj = kotlin_kotlin.$_$.r3;
  ...
  var Char__minus_impl_a2frrh_0 = kotlin_kotlin.$_$.p3;
  ...
  var indexOf = kotlin_kotlin.$_$.dg;
  ...
  var last_0 = kotlin_kotlin.$_$.ng;
  var get_lastIndex_0 = kotlin_kotlin.$_$.kg;
  ...
  var emptyMap = kotlin_kotlin.$_$.j8;
  var toDoubleOrNull = kotlin_kotlin.$_$.nh;
  var LazyThreadSafetyMode_NONE_getInstance = kotlin_kotlin.$_$.n;
  var lazy_0 = kotlin_kotlin.$_$.gk;
  ...
  var lineSequence = kotlin_kotlin.$_$.og;
  var mapNotNull = kotlin_kotlin.$_$.gf;
  ...
  function hasParameter($this, name, value) {
    ...
    switch ($this.get_parameters_cl4rkd_k$().get_size_woubt6_k$()) {
      ...
      case 1:
        ...
        break;
      default:
        var tmp2 = $this.get_parameters_cl4rkd_k$();
        var tmp$ret$2;
        $l$block_0: {
          // Inline function 'kotlin.collections.any' call
          var tmp_0;
          if (isInterface(tmp2, Collection)) {
            tmp_0 = tmp2.isEmpty_y1axqb_k$();
          } else {
            tmp_0 = false;
          }
          if (tmp_0) {
  ...
  protoOf(Companion).parse_pc1q8p_k$ = function (value) {
    ...
    var tmp2 = headerValue.get_value_j01efc_k$();
  ...
  protoOf(URLBuilder).build_1k0s4u_k$ = function () {
    applyOrigin(this);
    return new Url_1(this.protocolOrNull_1, this.host_1, this.port_1, this.get_pathSegments_2e2s6m_k$(), this.parameters_1.build_1k0s4u_k$(), this.get_fragment_bxnb4p_k$(), this.get_user_wovspg_k$(), this.get_password_bodifw_k$(), this.trailingQuery_1, this.buildString_xr87oh_k$());
  };
  ...
  function takeFromUnsafe(_this__u8e3s4, urlString) {
    ...
    if (_this__u8e3s4.get_protocol_mv93kx_k$().get_name_woqyms_k$() === 'about') {
      ...
      // Inline function 'kotlin.js.asDynamic' call
      var tmp$ret$13 = urlString.substring(startIndex_0, endIndex);
      _this__u8e3s4.set_host_sqck4b_k$(tmp$ret$13);
      return _this__u8e3s4;
    }
    if (slashCount >= 2) {
      loop: while (true) {
        ...
        if (delimiter < endIndex && charSequenceGet(urlString, delimiter) === _Char___init__impl__6a9atx(64)) {
          ...
          if (!(passwordIndex === -1)) {
            ...
            // Inline function 'kotlin.js.asDynamic' call
            var tmp$ret$17 = urlString.substring(startIndex_1, passwordIndex);
            _this__u8e3s4.set_encodedUser_shwszf_k$(tmp$ret$17);
            // Inline function 'kotlin.text.substring' call
            var startIndex_2 = passwordIndex + 1 | 0;
            // Inline function 'kotlin.js.asDynamic' call
            var tmp$ret$19 = urlString.substring(startIndex_2, delimiter);
            _this__u8e3s4.set_encodedPassword_m1etez_k$(tmp$ret$19);
          } else {
            // Inline function 'kotlin.text.substring' call
            var startIndex_3 = startIndex;
            // Inline function 'kotlin.js.asDynamic' call
            var tmp$ret$21 = urlString.substring(startIndex_3, delimiter);
            _this__u8e3s4.set_encodedUser_shwszf_k$(tmp$ret$21);
          }
  ...
  function Url(builder) {
    return takeFrom_0(new URLBuilder(), builder).build_1k0s4u_k$();
  }
  ...
  protoOf(Url_1).get_host_wonf8x_k$ = function () {
    return this.host_1;
  };
  protoOf(Url_1).get_specifiedPort_ldmo88_k$ = function () {
    return this.specifiedPort_1;
  };
  protoOf(Url_1).get_parameters_cl4rkd_k$ = function () {
    return this.parameters_1;
  };
  protoOf(Url_1).get_fragment_bxnb4p_k$ = function () {
    return this.fragment_1;
  };
  protoOf(Url_1).get_user_wovspg_k$ = function () {
    return this.user_1;
  };
  protoOf(Url_1).get_password_bodifw_k$ = function () {
    return this.password_1;
  };
  protoOf(Url_1).get_trailingQuery_m2fl7h_k$ = function () {
    return this.trailingQuery_1;
  };
  protoOf(Url_1).get_pathSegments_2e2s6m_k$ = function () {
    return this.pathSegments_1;
  };
  protoOf(Url_1).get_rawSegments_haqx6n_k$ = function () {
    return this.rawSegments_1;
  };
  protoOf(Url_1).get_segments_ecat1z_k$ = function () {
    var tmp0 = this.segments$delegate_1;
    // Inline function 'kotlin.getValue' call
    segments$factory();
    return tmp0.get_value_j01efc_k$();
  };
  protoOf(Url_1).get_protocolOrNull_xgbdu3_k$ = function () {
    return this.protocolOrNull_1;
  };
  protoOf(Url_1).get_protocol_mv93kx_k$ = function () {
    return this.protocol_1;
  };
  protoOf(Url_1).get_port_wosj4a_k$ = function () {
  ...
  protoOf(Url_1).get_encodedPath_p9zwnq_k$ = function () {
    var tmp0 = this.encodedPath$delegate_1;
    // Inline function 'kotlin.getValue' call
    encodedPath$factory();
    return tmp0.get_value_j01efc_k$();
  };
  protoOf(Url_1).get_encodedQuery_28s95p_k$ = function () {
    var tmp0 = this.encodedQuery$delegate_1;
    // Inline function 'kotlin.getValue' call
    encodedQuery$factory();
    return tmp0.get_value_j01efc_k$();
  };
  protoOf(Url_1).get_encodedPathAndQuery_81ied7_k$ = function () {
    var tmp0 = this.encodedPathAndQuery$delegate_1;
    // Inline function 'kotlin.getValue' call
    encodedPathAndQuery$factory();
    return tmp0.get_value_j01efc_k$();
  };
  protoOf(Url_1).get_encodedUser_p9wcq8_k$ = function () {
    var tmp0 = this.encodedUser$delegate_1;
    // Inline function 'kotlin.getValue' call
    encodedUser$factory();
    return tmp0.get_value_j01efc_k$();
  };
  protoOf(Url_1).get_encodedPassword_rswp28_k$ = function () {
    var tmp0 = this.encodedPassword$delegate_1;
    // Inline function 'kotlin.getValue' call
    encodedPassword$factory();
    return tmp0.get_value_j01efc_k$();
  };
  protoOf(Url_1).get_encodedFragment_jm6jcb_k$ = function () {
